# Servidor web local minimo para ClusteringPro.
...
# direccion (algo como http://192.168.1.23:8900) para escribirla en el
...
Write-Host ""
Write-Host "  ClusteringPro en marcha:  $prefix" -ForegroundColor Green
if ($lan) {
